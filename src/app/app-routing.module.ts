...
const routes: Routes = [
  { path: '', loadChildren: './saas-six/saas-six.module#SaasSixModule' },
  ...
  { path: 'landing-page8', loadChildren: () => import('./landing-page6/landing-page6.module').then(m => m.LandingPage6Module) },
